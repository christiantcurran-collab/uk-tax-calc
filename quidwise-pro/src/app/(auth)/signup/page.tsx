    ...
    return (
      <div className="min-h-screen bg-[#FAFAF8] flex items-center justify-center px-4">
        <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 max-w-md w-full text-center">
          ...
          <button
            onClick={() => { setConfirmEmail(false); router.push('/login'); }}
    ...
    <div className="min-h-screen bg-[#FAFAF8] flex items-center justify-center px-4">
      <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 max-w-md w-full">
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl font-bold text-[#1B4332]">Start your free trial</h1>
          <p className="text-gray-500 mt-1">14 days free · No credit bg-white rounded-2xl shadow-sm border border-gray-100 p-6 required</p>
        </div>

        {/* Benefits */}
        <div className="bg-[#95D5B2]/10 rounded-xl p-4 mb-6">
          <ul className="space-y-2">
            {[
              'AI receipt scanning',
              'HMRC-ready expense reports',
              'Mileage tracker',
            ].map((b) => (
              <li key={b} className="flex items-center gap-2 text-sm text-[#1B4332]">
        ...
        <form onSubmit={handleSignup} className="space-y-4">
          ...
          >
            {loading ? <LoadingSpinner size="sm" /> : 'Create Account & Start Trial'}
          </button>
        </form>
